package id.rizkyarifin.composebasic
...
import id.rizkyarifin.composebasic.ui.theme.ComposeBasicTheme
...
fun MyApp() {
    ...
    if (shouldShownOnBoarding)
        OnBoardingScreen(onContinuedClicked = { shouldShownOnBoarding = false })
    else
        Greetings()
}
